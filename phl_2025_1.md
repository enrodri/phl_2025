...
print("Complexity frequency and stratification\n" + '-'*40)
...
![png](phl_2025_1_files/phl_2025_1_7_1.png)
    ...
    ~\AppData\Local\Temp\ipykernel_21516\203555738.py in ?()
          3 
          4 # Your custom imputation comparison method
          5 print("Sensitivity analysis for the Stochastic Imputation\n" + '-'*40)
          6 viz.sensitivity_grid()
    ----> 7 df.sensitivity_report()
          8 
          9 # Complexity Analysis (Updated Markers: PH in, Shunts out)
         10 clinical_markers = ['Mixed_Mitral', 'Mixed_Aortic', 'Multi_Valve', 'PH_Significant', 'AFib_Present']
    

    c:\Users\Admin\Documents\Git\Statistics\phl_2025\venv_phl\Lib\site-packages\pandas\core\generic.py in ?(self, name)
    ...
    AttributeError: 'DataFrame' object has no attribute 'sensitivity_report'
