...
```
    ...
    Time:                        10:34:57   Log-Likelihood:                -222.20
...
```
    ...
    ========================================
                                OLS Regression Results                            
    ==============================================================================
    Dep. Variable:                    MBI   R-squared:                       0.349
    Model:                            OLS   Adj. R-squared:                  0.268
    Method:                 Least Squares   F-statistic:                     4.328
    Date:                Sat, 03 Jan 2026   Prob (F-statistic):           1.76e-05
    Time:                        10:34:57   Log-Likelihood:                -217.15
    No. Observations:                 110   AIC:                             460.3
    Df Residuals:                      97   BIC:                             495.4
    Df Model:                          12                                         
    Covariance Type:            nonrobust                                         
    ========================================================================================
                               coef    std err          t      P>|t|      [0.025      0.975]
    ----------------------------------------------------------------------------------------
    const                    3.7021      1.756      2.108      0.038       0.217       7.187
    Sev_MR                   0.4489      0.226      1.983      0.050      -0.000       0.898
    Sev_AR                   0.0746      0.268      0.278      0.781      -0.457       0.607
    Mixed_Mitral             1.9811      1.023      1.936      0.056      -0.049       4.012
    Mixed_Aortic            -1.9678      2.019     -0.974      0.332      -5.976       2.040
    Multi_Valve             -0.2812      1.019     -0.276      0.783      -2.303       1.741
    AFib_Present             1.0440      0.881      1.185      0.239      -0.705       2.793
    RVSP_Imputed             0.0311      0.008      3.821      0.000       0.015       0.047
    LVIDd_Imputed           -0.1453      0.237     -0.613      0.541      -0.616       0.325
    AO V2 max_Imputed       -0.0227      0.169     -0.135      0.893      -0.358       0.312
    MS MG (mmHg)_Imputed    -0.0273      0.041     -0.664      0.508      -0.109       0.054
    LA_Size_Score            0.3730      0.200      1.861      0.066      -0.025       0.771
    LVEF_Score              -0.0249      0.017     -1.435      0.155      -0.059       0.010
    ==============================================================================
    Omnibus:                        1.933   Durbin-Watson:                   1.832
    Prob(Omnibus):                  0.380   Jarque-Bera (JB):                1.923
    Skew:                           0.311   Prob(JB):                        0.382
    Kurtosis:                       2.818   Cond. No.                         786.
    ==============================================================================
...
```
    ...
    ========================================
                                OLS Regression Results                            
    ==============================================================================
    Dep. Variable:                    MBI   R-squared:                       0.443
    Model:                            OLS   Adj. R-squared:                  0.361
    Method:                 Least Squares   F-statistic:                     5.396
    Date:                Sat, 03 Jan 2026   Prob (F-statistic):           1.84e-07
    Time:                        10:34:57   Log-Likelihood:                -208.55
    No. Observations:                 110   AIC:                             447.1
    Df Residuals:                      95   BIC:                             487.6
    Df Model:                          14                                         
    Covariance Type:            nonrobust                                         
    ========================================================================================
                               coef    std err          t      P>|t|      [0.025      0.975]
    ----------------------------------------------------------------------------------------
    const                   -0.9183      2.040     -0.450      0.654      -4.968       3.132
    Age                      0.0171      0.012      1.392      0.167      -0.007       0.041
    Weight                   0.0358      0.013      2.680      0.009       0.009       0.062
    Sev_MR                   0.3575      0.216      1.656      0.101      -0.071       0.786
    Sev_AR                  -0.1282      0.257     -0.499      0.619      -0.638       0.382
    Mixed_Mitral             2.1207      0.965      2.198      0.030       0.206       4.036
    Mixed_Aortic            -2.0424      1.900     -1.075      0.285      -5.815       1.730
    Multi_Valve             -0.0395      0.955     -0.041      0.967      -1.936       1.857
    AFib_Present             0.5069      0.836      0.606      0.546      -1.153       2.167
    RVSP_Imputed             0.0338      0.008      4.417      0.000       0.019       0.049
    LVIDd_Imputed            0.0107      0.225      0.048      0.962      -0.436       0.457
    AO V2 max_Imputed       -0.0252      0.162     -0.155      0.877      -0.347       0.296
    MS MG (mmHg)_Imputed    -0.0082      0.041     -0.200      0.842      -0.089       0.073
    LA_Size_Score            0.3429      0.188      1.827      0.071      -0.030       0.715
    LVEF_Score              -0.0181      0.016     -1.101      0.274      -0.051       0.015
    ==============================================================================
    Omnibus:                        2.540   Durbin-Watson:                   1.934
    Prob(Omnibus):                  0.281   Jarque-Bera (JB):                2.537
    Skew:                           0.326   Prob(JB):                        0.281
    Kurtosis:                       2.641   Cond. No.                     1.40e+03
    ==============================================================================
...
```
    ...
    ========================================
                                OLS Regression Results                            
    ==============================================================================
    Dep. Variable:           RVSP_Imputed   R-squared:                       0.250
    Model:                            OLS   Adj. R-squared:                  0.140
    Method:                 Least Squares   F-statistic:                     2.265
    Date:                Sat, 03 Jan 2026   Prob (F-statistic):             0.0104
    Time:                        10:34:57   Log-Likelihood:                -483.95
    No. Observations:                 110   AIC:                             997.9
    Df Residuals:                      95   BIC:                             1038.
    Df Model:                          14                                         
    Covariance Type:            nonrobust                                         
    ========================================================================================
                               coef    std err          t      P>|t|      [0.025      0.975]
    ----------------------------------------------------------------------------------------
    const                   36.7268     24.685      1.488      0.140     -12.280      85.734
    Age                     -0.1698      0.151     -1.128      0.262      -0.469       0.129
    Weight                  -0.2269      0.168     -1.351      0.180      -0.560       0.107
    MBI                      5.0474      1.143      4.417      0.000       2.779       7.316
    Sev_MR                  -1.8975      2.670     -0.711      0.479      -7.198       3.403
    Sev_AR                   1.4812      3.141      0.472      0.638      -4.754       7.716
    Mixed_Mitral            -4.4941     12.082     -0.372      0.711     -28.480      19.492
    Mixed_Aortic             2.9722     23.376      0.127      0.899     -43.436      49.380
    Multi_Valve              1.1415     11.681      0.098      0.922     -22.048      24.331
    AFib_Present            -4.6696     10.230     -0.456      0.649     -24.979      15.639
    LVIDd_Imputed           -0.0200      2.750     -0.007      0.994      -5.480       5.440
    AO V2 max_Imputed        0.1367      1.981      0.069      0.945      -3.797       4.070
    MS MG (mmHg)_Imputed     0.9382      0.490      1.915      0.059      -0.034       1.911
    LA_Size_Score           -1.7567      2.327     -0.755      0.452      -6.377       2.863
    LVEF_Score               0.1045      0.202      0.517      0.606      -0.297       0.506
    ==============================================================================
    Omnibus:                       95.083   Durbin-Watson:                   1.422
    Prob(Omnibus):                  0.000   Jarque-Bera (JB):              929.689
    Skew:                           2.860   Prob(JB):                    1.32e-202
    Kurtosis:                      16.043   Cond. No.                     1.32e+03
    ==============================================================================
...
```
    ...
    ========================================
                                OLS Regression Results                            
    ==============================================================================
    Dep. Variable:             LVEF_Score   R-squared:                       0.252
    Model:                            OLS   Adj. R-squared:                  0.142
    Method:                 Least Squares   F-statistic:                     2.288
    Date:                Sat, 03 Jan 2026   Prob (F-statistic):            0.00957
    Time:                        10:34:57   Log-Likelihood:                -409.21
    No. Observations:                 110   AIC:                             848.4
    Df Residuals:                      95   BIC:                             888.9
    Df Model:                          14                                         
    Covariance Type:            nonrobust                                         
    ========================================================================================
                               coef    std err          t      P>|t|      [0.025      0.975]
    ----------------------------------------------------------------------------------------
    const                   81.8420      9.472      8.640      0.000      63.038     100.646
    Age                      0.0704      0.076      0.920      0.360      -0.081       0.222
    Weight                  -0.1038      0.085     -1.218      0.226      -0.273       0.065
    MBI                     -0.6959      0.632     -1.101      0.274      -1.950       0.559
    Sev_MR                  -0.9213      1.354     -0.681      0.498      -3.609       1.766
    Sev_AR                  -2.8418      1.567     -1.814      0.073      -5.953       0.269
    Mixed_Mitral             9.1380      6.057      1.509      0.135      -2.886      21.162
    Mixed_Aortic            13.9551     11.764      1.186      0.238      -9.399      37.309
    Multi_Valve            -10.3242      5.826     -1.772      0.080     -21.890       1.242
    AFib_Present            -9.4575      5.100     -1.855      0.067     -19.582       0.667
    RVSP_Imputed             0.0269      0.052      0.517      0.606      -0.076       0.130
    LVIDd_Imputed           -4.0048      1.332     -3.006      0.003      -6.650      -1.360
    AO V2 max_Imputed       -0.5870      1.003     -0.586      0.560      -2.577       1.403
    MS MG (mmHg)_Imputed     0.0406      0.253      0.161      0.873      -0.462       0.543
    LA_Size_Score            1.6501      1.171      1.409      0.162      -0.675       3.975
    ==============================================================================
    Omnibus:                       32.453   Durbin-Watson:                   2.198
    Prob(Omnibus):                  0.000   Jarque-Bera (JB):               56.601
    Skew:                          -1.284   Prob(JB):                     5.12e-13
    Kurtosis:                       5.399   Cond. No.                     1.11e+03
    ==============================================================================
...
ax2.plot(x_curve, benefit_curve, color='#2980b9', linewidth=3, label='Surgical Benefit Score')
...
plt.tight_layout()
plt.show()
plt.savefig('mbi_triage_u_shape.png', dpi=300)
```
...
![png](phl_2025_files/phl_2025_47_1.png)
...
```
    ...
    [NbConvertApp] Writing 141801 bytes to phl_2025.md
