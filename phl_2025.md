...
class Visualizer:
    ...
    def predictor_decomposition(self):
        ...
        composition_data = []
            ...
            # 1. Gather granular drug data using your pre-parsed columns
            for category, weight in self.config.class_weights.items():
                name_col = f"{category}_name"
                dose_col = f"{category}_tdd"
                ...
                if name_col in self.df.columns and dose_col in self.df.columns:
                    ...
                    # Map drug names to max doses and calculate intensity
                    ...
                    # Group by drug to get specific contributions
            ...
            # 2. Sort by Clinical Weight (Priority) to keep logic consistent
            ...
            fig = px.bar(
                ...
                y="Medication_Class", 
                x="Burden_Score", 
                color="Medication_Class",  # Keeps consistent color schema within the category
                orientation='h',
                title=f"Global Pharmacological Architecture (n={len(self.df)})",
                hover_data={
                    'Specific_Drug': True,
                    'Percentage_of_Class': ':.1f',
                    'Burden_Score': ':.2f',
                    'Clinical_Weight': True,
                    'Medication_Class': False # Already on Y axis
                },
                labels={'Burden_Score': 'Weighted Burden Contribution (Aggregate Severity Score)'}
            )

            # 4. Styling for Portfolio Quality
            fig.update_layout(
                barmode='stack',
                yaxis={'categoryorder': 'array', 'categoryarray': df_comp['Medication_Class'].unique()[::-1]},
                showlegend=False, # Color is mapped to class, legend is redundant
                height=800,
...
![png](phl_2025_1_files/phl_2025_1_8_2.png)
...
![png](phl_2025_1_files/phl_2025_1_8_6.png)
...
![png](phl_2025_1_files/phl_2025_1_8_9.png)
...
![png](phl_2025_1_files/phl_2025_1_8_11.png)
...
![png](phl_2025_1_files/phl_2025_1_8_13.png)
...
<table border="1" class="dataframe">
  ...
  <tbody>
    ...
    <tr>
      <th>20</th>
      <td>Anticoagulants_Antiplatelets</td>
      <td>Apixaban</td>
      <td>2.500000</td>
      <td>1.0</td>
      <td>2.763042</td>
